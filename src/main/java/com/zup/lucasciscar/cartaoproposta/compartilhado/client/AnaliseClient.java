...
import com.zup.lucasciscar.cartaoproposta.proposta.PropostaLegadoRequest;
...
public interface AnaliseClient {
    ...
    Map<String, Object> solicitarAnalise(@RequestBody PropostaLegadoRequest propostaAnalise);
}
